    ...
    <div style={{ minHeight: "100vh", background: "#ffffff", fontFamily: "Inter, Arial, sans-serif" }}>
      ...
      <section style={{ maxWidth: 1000, margin: "60px auto 40px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "1.1rem", color: "#555", lineHeight: 1.8 }}>
          Track your personal and professional finances effortlessly. Track your income, expenses, savings, clients, quotations, and invoices all in one place.
        </p>
      </section>
      ...
      <section style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", maxWidth: 1300, margin: "0 auto", padding: "0 16px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", width: "35%", marginTop: 0 }}>
          <h2 style={{ fontSize: "1.6rem", marginBottom: 24, color: "#0d1f4c" }}>✨ Features</h2>
          <ul style={{ listStyle: "none", paddingLeft: 0, lineHeight: 2, textAlign: "left", borderLeft: "3px solid #1f6feb", paddingLeft: 16 }}>
            <li style={{ marginBottom: 12 }}>💰 Track personal income, expenses and savings</li>
